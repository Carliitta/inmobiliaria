...
const Desarrollador = () => {
  return (
    ...
    <div className="d-flex flex-column min-vh-100" style={{ justifyContent: 'center', alignItems: 'center' }}>
      ...
      <div className="carli card b-3 p-2 mb-2" style={{ width: '500px', alignItems: 'center', backgroundColor:'#ffe307cf' }}>
        <img
        ...
        <p className='card-text  text-center fs-5'> Apasionada por la tecnología.👩‍💻🚀</p>
